...
class PassageTagger(object):
    ...
    def make_data(self, trainfilename, maxseqlen=None, maxclauselen=None, label_ind=None, train=False):
        ...
        discourse_generator = BertDiscourseGenerator(self.bert, self.tokenizer, str_seqs, label_seqs, self.label_ind,
                                                     batch_size, use_attention, self.maxseqlen, self.maxclauselen, train)
